angular.module('fittr.controllers')
  ...
  .controller('EntryController', ['$scope', 'AuthService', 'Facebook', function($scope, AuthService, Facebook) {
    ...
    $scope.login = function() {
      Facebook.login(function(response) {
        ...
        if (response.status == 'connected') {
          $scope.logged = true;
          $scope.me();
          // TODO: what should we do if user doesn't have an email associated with fb account?
        } else {
